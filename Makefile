...
fmt:              ## Format code using black & isort.
	...
	$(ENV_PREFIX)black -l 79 repltilian/
	$(ENV_PREFIX)black -l 79 tests/

.PHONY: lint
lint:             ## Run pep8, black, mypy linters.
	$(ENV_PREFIX)flake8 repltilian/
	$(ENV_PREFIX)black -l 79 --check repltilian/
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "repltilian = 'repltilian.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run repltilian'"
